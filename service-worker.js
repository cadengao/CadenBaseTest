import { config } from "/package_50b5ddb7b30eca7fc6d9e006a5df71a65d055ffd/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_50b5ddb7b30eca7fc6d9e006a5df71a65d055ffd').then(async function (cache) {
