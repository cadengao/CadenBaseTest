import { config } from "/package_b360b357f4cb246409f9fb40fb06238e5ed56b42/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_b360b357f4cb246409f9fb40fb06238e5ed56b42').then(async function (cache) {
